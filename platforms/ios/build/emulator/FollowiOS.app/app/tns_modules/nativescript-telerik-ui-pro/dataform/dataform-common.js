    ...
    EntityProperty.prototype.onValuesProviderChanged = function (oldValue, newValue) {
        if (newValue) {
            ...
            if (newValue instanceof Map) {
                ...
                var labelProperty = this._getLabelProperty(this.valuesProvider);
                simplifiedArray = newValue.items.map(function (item) { return item[labelProperty]; });
                this._setupConverterWith(keyProperty, labelProperty, newValue.items);
            }
    ...
    PropertyEditor.prototype.onPropertyEditorStylePropertyChanged = function (oldValue, newValue) {
        ...
        if (newValue) {
            ...
            var changeHandler = function (propertyChangeData) {
                that.get().onStylePropertyChanged(propertyChangeData.propertyName);
            };
...
var ValuesProviderArrayConverter = (function () {
...
var ValuesProviderMapConverter = (function () {
